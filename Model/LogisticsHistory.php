...
namespace Lovevox\Logistics\Model;
 ...
 */
class LogisticsHistory extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Lovevox\Logistics\Model\ResourceModel\LogisticsHistoryEntity');
    }
}
